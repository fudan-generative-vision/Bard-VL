...
def apply_liger_kernel_to_qwen3_vl(
    ...
    import nemo_automodel.components.models.qwen3_vl.modeling_qwen3_vl as modeling_qwen3_vl
    from nemo_automodel.components.models.qwen3_vl.modeling_qwen3_vl import (
